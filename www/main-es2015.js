...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                loadChildren: () => Promise.all(/*! import() | recipes-recipes-module */[__webpack_require__.e("common"), __webpack_require__.e("recipes-recipes-module")]).then(__webpack_require__.bind(null, /*! ./recipes/recipes.module */ "./src/app/recipes/recipes.module.ts")).then(m => m.RecipesPageModule)
            },
            {
                path: ':recipeId',
                loadChildren: () => Promise.all(/*! import() | recipes-recipe-detail-recipe-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("recipes-recipe-detail-recipe-detail-module")]).then(__webpack_require__.bind(null, /*! ./recipes/recipe-detail/recipe-detail.module */ "./src/app/recipes/recipe-detail/recipe-detail.module.ts")).then(m => m.RecipeDetailPageModule)
            }
        ]
    },
];
...
module.exports = __webpack_require__(/*! C:\Users\gabor\Desktop\Udemy_Ionic_5\ionic-angular-course\src\main.ts */"./src/main.ts");
